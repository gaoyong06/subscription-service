...
type CreateSubscriptionOrderRequest struct {
	...
	CouponCode    string                 `protobuf:"bytes,5,opt,name=coupon_code,json=couponCode,proto3" json:"coupon_code,omitempty"`          // 优惠券码（可选）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateSubscriptionOrderRequest) GetCouponCode() string {
	if x != nil {
		return x.CouponCode
	}
	return ""
...
const file_subscription_proto_rawDesc = "" +
	...
	"\n" +
	"auto_renew\x18\x06 \x01(\bR\tautoRenew\"\xd9\x01\n" +
