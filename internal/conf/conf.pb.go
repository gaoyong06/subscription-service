...
type Client struct {
	...
	SubscriptionService *SubscriptionService   `protobuf:"bytes,2,opt,name=subscription_service,json=subscriptionService,proto3" json:"subscription_service,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *Client) GetSubscriptionService() *SubscriptionService {
	if x != nil {
...
type SubscriptionService struct {
	...
	AutoRenewDaysBefore int32                  `protobuf:"varint,2,opt,name=auto_renew_days_before,json=autoRenewDaysBefore,proto3" json:"auto_renew_days_before,omitempty"`
	ExpiryCheckDays     int32                  `protobuf:"varint,3,opt,name=expiry_check_days,json=expiryCheckDays,proto3" json:"expiry_check_days,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}

func (x *SubscriptionService) Reset() {
...
func (x *SubscriptionService) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubscriptionService) ProtoMessage() {}

func (x *SubscriptionService) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubscriptionService.ProtoReflect.Descriptor instead.
func (*SubscriptionService) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{5}
}

func (x *SubscriptionService) GetReturnUrl() string {
	if x != nil {
		return x.ReturnUrl
	}
	return ""
...
func (x *SubscriptionService) GetAutoRenewDaysBefore() int32 {
	if x != nil {
...
func (x *SubscriptionService) GetExpiryCheckDays() int32 {
	if x != nil {
...
const file_internal_conf_conf_proto_rawDesc = "" +
	"\n" +
	"\x18internal/conf/conf.proto\x12\x11subscription.conf\x1a\x1egoogle/protobuf/duration.proto\"\xc8\x01\n" +
	"\tBootstrap\x121\n" +
	...
	"\x06client\x18\x03 \x01(\v2\x19.subscription.conf.ClientR\x06client\x12(\n" +
	"\x03log\x18\x04 \x01(\v2\x16.subscription.conf.LogR\x03log\"\xc6\x02\n" +
	"\x06Server\x122\n" +
	...
	"\x0emin_idle_conns\x18\t \x01(\x05R\fminIdleConns\"\xaf\x01\n" +
	"\x06Client\x12J\n" +
	"\x0fpayment_service\x18\x01 \x01(\v2!.subscription.conf.PaymentServiceR\x0epaymentService\x12Y\n" +
	"\x14subscription_service\x18\x02 \x01(\v2&.subscription.conf.SubscriptionServiceR\x13subscriptionService\"$\n" +
	"\x0ePaymentService\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\"\x95\x01\n" +
	"\x13SubscriptionService\x12\x1d\n" +
	"\n" +
	"return_url\x18\x01 \x01(\tR\treturnUrl\x123\n" +
	"\x16auto_renew_days_before\x18\x02 \x01(\x05R\x13autoRenewDaysBefore\x12*\n" +
	"\x11expiry_check_days\x18\x03 \x01(\x05R\x0fexpiryCheckDays\"\xd9\x01\n" +
	"\x03Log\x12\x14\n" +
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*SubscriptionService)(nil), // 5: subscription.conf.SubscriptionService
	(*Log)(nil),                 // 6: subscription.conf.Log
	(*Server_HTTP)(nil),         // 7: subscription.conf.Server.HTTP
	(*Server_GRPC)(nil),         // 8: subscription.conf.Server.GRPC
	(*Data_Database)(nil),       // 9: subscription.conf.Data.Database
	(*Data_Redis)(nil),          // 10: subscription.conf.Data.Redis
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	6,  // 3: subscription.conf.Bootstrap.log:type_name -> subscription.conf.Log
	7,  // 4: subscription.conf.Server.http:type_name -> subscription.conf.Server.HTTP
	8,  // 5: subscription.conf.Server.grpc:type_name -> subscription.conf.Server.GRPC
	9,  // 6: subscription.conf.Data.database:type_name -> subscription.conf.Data.Database
	10, // 7: subscription.conf.Data.redis:type_name -> subscription.conf.Data.Redis
	4,  // 8: subscription.conf.Client.payment_service:type_name -> subscription.conf.PaymentService
	5,  // 9: subscription.conf.Client.subscription_service:type_name -> subscription.conf.SubscriptionService
	11, // 10: subscription.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	11, // 11: subscription.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	11, // 12: subscription.conf.Data.Database.conn_max_lifetime:type_name -> google.protobuf.Duration
	11, // 13: subscription.conf.Data.Redis.dial_timeout:type_name -> google.protobuf.Duration
	11, // 14: subscription.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	11, // 15: subscription.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
