...
type SubscriptionOrder struct {
	...
	UserID        string    `gorm:"column:user_id;type:varchar(36);index:idx_user_id"` // 用户ID（字符串 UUID）
	PlanID        string    `gorm:"column:plan_id"`
	AppID         string    `gorm:"column:app_id;type:varchar(50);index"`
	CampaignID    string    `gorm:"column:campaign_id;type:varchar(64);index"`
	ClickID       string    `gorm:"column:click_id;type:varchar(64);index"`
